...
public:
    int minTimeToReach(vector<vector<int>>& moveTime) {
        ...
        // pura code same as lc 3341, bss step count (1 or 2) wala logic ka explanation likha maine
        ...
        while (!pq.empty()) {
            ...
            // jab first time (n-1,m-1) par pahuchenge it will be smallest time, yehi se return krdo ans ko(mik probably)
