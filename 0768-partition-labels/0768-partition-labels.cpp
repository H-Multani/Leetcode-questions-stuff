...
public:
    vector<int> partitionLabels(string s) {
        ...
        // jayega, ab apan i=1 se 8 tak chalaenge, agar beech me koi aur char
        // mila jiska jiska last idx>8 hai toh ye wala partition expand hoga
        // i=1, c hai, c ka ending idx is 9, toh ye partition 8 par nai 9 par
        // khatam hoga, so that curr char appears in only 1 partition(valid
        // partition banane vaaste)
        // i=2, me c hai, last char at idx 9, current ending is idx 9
        // i=3, me b hai, last char at idx 6, current ending is idx 9
        // i=4, me b hai, last char at idx 6, current ending is idx 9
        // i=5, me b hai, last char at idx 6, current ending is idx 9
        // i=6, me b hai, last char at idx 6, current ending is idx 9
        // i=7, me d hai, last char at idx 7, current ending is idx 9
        // i=8, me e hai, last char at idx 8, current ending is idx 9
        // i=9, me c hai, last char at idx 9, current ending is idx 9
        // toh ye wala partition me 9-0+1=10 char honge, ans me
        // daal kar aage badhenge starting new partition frm i=10 now, repeat
        // same process
