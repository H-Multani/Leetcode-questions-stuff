        ...
        for (int col = 0; col < n; col++) {
            ...
            for (int row = m - 1; row >= 0; row--) {
                if (ans[row][col] == '#') {
                    ...
                    // ke upar rahega, hence emptyidx ko just obstacle ke upar wale
                    // idx par rakh do , ie emptyidx ko curr location se 1 upar rakh
                    // do
                    emptyidx = row - 1;
